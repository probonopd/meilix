...
echo "gh-releases-zsync|probonopd|meilix|latest|custom-*amd64.iso.zsync" | dd of="custom-desktop-amd64.iso" bs=1 seek=33651 count=512 conv=notrunc 2>/dev/null 
